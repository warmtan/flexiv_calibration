...
def calibrate(config):
    ...
    def get_rigid_transform_error(z_scale):
        ...
        return rmse
    point = [checkerboard_x,checkerboard_y,checkerboard_z]
    ...
    if z_3d > 0.0:
        ...
        print("world_transform:",cam_pose)
        print("world_transform[0:3,0:3]",cam_pose[0:3,0:3])
        print("world_transform[0:3,3:]",cam_pose[0:3,3:])
        world_position = np.dot(cam_pose[0:3,0:3], points) + cam_pose[0:3,3:]
    else:
        return None
    robot.move_wrt_tool(world_position)
